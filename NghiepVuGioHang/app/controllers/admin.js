...
let addProduct = () => {
    ...
    console.log('form value: ',formValue) // xem formValue có gì nè
    /**
     * rồi mới destructuring các thuộc tính theo đúng property có trong formValue;
     * log formValue là sẽ thấy mấy cái thuộc tính phía dưới.
     */

    let {CameraSauSP,CameraTruocSP,GiaSP,HinhSP,LoaiDienThoaiSP,ManHinhSP,MoTa,TenSP} = formValue;
    // let CameraSauSP = formValue.CameraSauSP;
    // let CameraTruocSP = formValue.CameraTruocSP;
    // let GiaSP = formValue.GiaSP;
    // let HinhSP = formValue.HinhSP;
    // let LoaiDienThoaiSP = formValue.LoaiDienThoaiSP;
    // let ManHinhSP = formValue.ManHinhSP;
    // let MoTa = formValue.MoTa;
    // let TenSP = formValue.TenSP;
    // let {CameraSauSP,CameraTruocSP,GiaSP,HinhSP,LoaiDienThoaiSP,ManHinhSP,MoTa,TenSP} = formValue;

    let sp = new SanPham(TenSP,GiaSP,ManHinhSP,CameraSauSP,CameraTruocSP,HinhSP,MoTa,LoaiDienThoaiSP);
    console.table(sp);
